...
<html>
<head>
    <title>{{(ucwords(request()->path())!='/')?ucwords(request()->path()):'Welcome'}} | Crop ML</title>
    ...
    <meta name="keywords" content="Crop ML Responsive web template, Bootstrap Web Templates, Flat Web Templates, AndriodCompatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    <!--Google Fonts-->
    ...
    <div class="header">
        <div class="container">
            <div class="header-main">
                <div class="head-left">
                    <div class="phone">
                        <p><a target='_blank' href="" style="color:#956295"><i class="fa fa-github fa-2x"></i></a></p>
    ...
    <div class="container">
        <div class="footer-main">
            ...
            <div class="col-md-4 ftr-grd">
                <h3>Get Social</h3>
                <ul>
                    <li><a target='_blank'  href=""><span class="fa"> </span></a></li>
                    <li><a target='_blank'  href=""><span class="tw"> </span></a></li>
                    <li><a target='_blank'  href=""><span class="in"> </span></a></li>
                </ul>
            </div>
            <div class="col-md-4 ftr-grd">
                <h3>Contact Us</h3>
